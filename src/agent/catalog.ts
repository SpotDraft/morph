...
export const AGENT_TOOLS: AgentTool[] = [
  ...
  },
  {
    ...
    purpose: "Tracked rewrite of one table cell's paragraph text (inspect.tables cell nodeId / row+col).",
    when: "inspect.tables shows the cell. Prefer rowIndex+columnIndex. v2 setCellText is not tracked; Morph rewrites the cell paragraph.",
